package ai.timefold.solver.examples.common.swingui;
    ...
    protected class SolveWorker extends SwingWorker<Solution_, Void> {
        ...
        protected void done() {
            ...
            try {
                ...
                resetScreen();
                if (bestSolution != null && bestSolution instanceof OledSchedule) {
                    OledSchedule solution = (OledSchedule) bestSolution;
