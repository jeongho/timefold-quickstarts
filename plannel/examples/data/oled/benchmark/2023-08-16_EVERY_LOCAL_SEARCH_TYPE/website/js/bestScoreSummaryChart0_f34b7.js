...
var chart_bestScoreSummaryChart0_f34b7 = new Chart(document.getElementById('chart_bestScoreSummaryChart0_f34b7'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_bestScoreSummaryChart0_f34b7.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScoreSummaryChart0_f34b7.resize();
});