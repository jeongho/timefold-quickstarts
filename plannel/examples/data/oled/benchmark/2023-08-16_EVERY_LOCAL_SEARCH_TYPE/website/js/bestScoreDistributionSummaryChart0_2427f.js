...
var chart_bestScoreDistributionSummaryChart0_2427f = new Chart(document.getElementById('chart_bestScoreDistributionSummaryChart0_2427f'), {
    type: 'boxplot',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_bestScoreDistributionSummaryChart0_2427f.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScoreDistributionSummaryChart0_2427f.resize();
});