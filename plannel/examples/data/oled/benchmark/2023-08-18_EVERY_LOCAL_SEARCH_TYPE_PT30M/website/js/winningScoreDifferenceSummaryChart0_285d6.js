...
var chart_winningScoreDifferenceSummaryChart0_285d6 = new Chart(document.getElementById('chart_winningScoreDifferenceSummaryChart0_285d6'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_winningScoreDifferenceSummaryChart0_285d6.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_winningScoreDifferenceSummaryChart0_285d6.resize();
});