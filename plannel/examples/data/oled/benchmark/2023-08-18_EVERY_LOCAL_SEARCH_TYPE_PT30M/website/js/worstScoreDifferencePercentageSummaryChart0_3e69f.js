...
var chart_worstScoreDifferencePercentageSummaryChart0_3e69f = new Chart(document.getElementById('chart_worstScoreDifferencePercentageSummaryChart0_3e69f'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_worstScoreDifferencePercentageSummaryChart0_3e69f.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_worstScoreDifferencePercentageSummaryChart0_3e69f.resize();
});