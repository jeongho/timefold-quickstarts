...
var chart_bestScoreDistributionSummaryChart0_c246b = new Chart(document.getElementById('chart_bestScoreDistributionSummaryChart0_c246b'), {
    type: 'boxplot',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_bestScoreDistributionSummaryChart0_c246b.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScoreDistributionSummaryChart0_c246b.resize();
});