...
var chart_winningScoreDifferenceSummaryChart1_1d586 = new Chart(document.getElementById('chart_winningScoreDifferenceSummaryChart1_1d586'), {
    type: 'bar',
    data: {
        labels: [
        ...
        datasets: [
            {
                  ...
                  ,
                  data: [
                    -100, -900, -900, -3900, -900, -1200, 0, 0, -500, -400, 0, 0, -300, -100
                  ]
                }, 
{
                  label: 'TABU_SEARCH',
                  ...
                  ,
                  data: [
                    -6400, -15800, -23800, -135100, -2600, -5700, 0, 0, -4700, -8100, 0, 0, -600, -200
                  ]
                }, 
{
                ...
                }, 
{
                  ...
                  ,
                  data: [
                    -300, -700, -1900, -9600, -200, -200, 0, 0, -400, -300, 0, 0, 0, -100
                  ]
                }, 
{
                  ...
                  ,
                  data: [
                    -177200, -342800, -404000, -764000, -11600, -41000, 0, 0, -55200, -129400, 0, 0, -600, -3400
                  ]
                }
        ]
    },
...
window.addEventListener('beforeprint', () => {
  chart_winningScoreDifferenceSummaryChart1_1d586.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_winningScoreDifferenceSummaryChart1_1d586.resize();
});