...
var chart_winningScoreDifferenceSummaryChart2_9c8ca = new Chart(document.getElementById('chart_winningScoreDifferenceSummaryChart2_9c8ca'), {
    type: 'bar',
    data: {
        labels: [
        ...
        datasets: [
            {
                  ...
                  ,
                  data: [
                    -1619200, 19980100, 12437300, 118143000, -109700, -34400, 0, 0, -563100, -1592400, 0, -5700, 62600, 43000
                  ]
                }, 
{
                  label: 'TABU_SEARCH',
                  ...
                  ,
                  data: [
                    -2704500, 21407000, 11927500, 117027500, -149600, -1012500, 0, 0, -775700, -2372800, -400, -300, -3400, 95300
                  ]
                }, 
{
                ...
                }, 
{
                  ...
                  ,
                  data: [
                    -1388600, 20591900, 7527500, -1522700, -127500, -289500, 0, 0, -576900, -631500, -9300, -25600, -11400, -2867000
                  ]
                }, 
{
                  ...
                  ,
                  data: [
                    -11769900, -22390400, -8985500, 30460100, -119800, -4064600, 0, 0, -3938200, -19430800, -100, -9600, -4900, -278800
                  ]
                }
        ]
    },
...
window.addEventListener('beforeprint', () => {
  chart_winningScoreDifferenceSummaryChart2_9c8ca.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_winningScoreDifferenceSummaryChart2_9c8ca.resize();
});