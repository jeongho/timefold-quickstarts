...
var chart_bestScoreSummaryChart0_96ce = new Chart(document.getElementById('chart_bestScoreSummaryChart0_96ce'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_bestScoreSummaryChart0_96ce.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScoreSummaryChart0_96ce.resize();
});