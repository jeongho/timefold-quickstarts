...
var chart_bestScoreSummaryChart1_3fdf5 = new Chart(document.getElementById('chart_bestScoreSummaryChart1_3fdf5'), {
    type: 'bar',
    data: {
        labels: [
        ...
        datasets: [
            {
                  ...
                  ,
                  data: [
                    -1009, -2011, -1756, -3505, -276, -543, -71, -136, -376, -740, -54, -107, -56, -106
                  ]
                }, 
{
                  label: 'TABU_SEARCH',
                  ...
                  ,
                  data: [
                    -1072, -2160, -1985, -4817, -293, -588, -71, -136, -418, -817, -54, -107, -59, -107
                  ]
                }, 
{
...
,
                  data: [
                    -1008, -2002, -1747, -3466, -267, -531, -71, -136, -371, -736, -54, -107, -53, -105
                  ]
                }, 
{
                  label: 'GREAT_DELUGE',
                  ...
                  ,
                  data: [
                    -1011, -2009, -1766, -3562, -269, -533, -71, -136, -375, -739, -54, -107, -53, -106
                  ]
                }, 
{
                  ...
                  ,
                  data: [
                    -2780, -5430, -5787, -11106, -383, -941, -71, -136, -923, -2030, -54, -107, -59, -139
                  ]
                }
        ]
    },
...
window.addEventListener('beforeprint', () => {
  chart_bestScoreSummaryChart1_3fdf5.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScoreSummaryChart1_3fdf5.resize();
});