...
var chart_bestScoreProblemStatisticChart0_dec = new Chart(document.getElementById('chart_bestScoreProblemStatisticChart0_dec'), {
    type: 'line',
    data: {
        labels: [
            382, 393, 423, 424, 425, 427, 428, 431, 437, 440, 443, 444, 447, 477, 483, 2253, 2369, 2404, 2415, 2416, 4081, 4185, 4210, 4216, 4253, 4278, 4347, 4488, 4788, 300000, 300001, 300002
        ],
        datasets: [
            {
...
window.addEventListener('beforeprint', () => {
  chart_bestScoreProblemStatisticChart0_dec.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScoreProblemStatisticChart0_dec.resize();
});
