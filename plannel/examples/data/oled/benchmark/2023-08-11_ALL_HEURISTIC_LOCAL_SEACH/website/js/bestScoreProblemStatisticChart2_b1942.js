...
var chart_bestScoreProblemStatisticChart2_b1942 = new Chart(document.getElementById('chart_bestScoreProblemStatisticChart2_b1942'), {
    type: 'line',
    data: {
        labels: [
            300000
...
window.addEventListener('beforeprint', () => {
  chart_bestScoreProblemStatisticChart2_b1942.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScoreProblemStatisticChart2_b1942.resize();
});
