...
var chart_bestScoreProblemStatisticChart0_42599 = new Chart(document.getElementById('chart_bestScoreProblemStatisticChart0_42599'), {
    type: 'line',
    data: {
        labels: [
            13, 15, 16, 18, 19, 21, 22, 24, 91, 94, 97, 99, 107, 135, 141, 143, 150, 194, 201, 204, 217, 300000, 300001
        ],
        datasets: [
            {
                ...
                }, 
{
    ...
    options: {
        ...
        plugins: {
            title: {
                display: true,
                text: 'oled-bench-20c-101o-30ts-baking-maint best hard score statistic'
            },
            tooltip: {
                callbacks: {
...
window.addEventListener('beforeprint', () => {
  chart_bestScoreProblemStatisticChart0_42599.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScoreProblemStatisticChart0_42599.resize();
});
