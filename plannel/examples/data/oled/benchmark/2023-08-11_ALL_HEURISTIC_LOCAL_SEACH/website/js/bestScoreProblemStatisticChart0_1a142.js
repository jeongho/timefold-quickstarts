...
var chart_bestScoreProblemStatisticChart0_1a142 = new Chart(document.getElementById('chart_bestScoreProblemStatisticChart0_1a142'), {
    type: 'line',
    data: {
        labels: [
            7, 9, 10, 11, 12, 17, 19, 20, 21, 22, 38, 39, 41, 45, 47, 48, 52, 58, 300000, 300004
        ],
        datasets: [
            {
...
window.addEventListener('beforeprint', () => {
  chart_bestScoreProblemStatisticChart0_1a142.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScoreProblemStatisticChart0_1a142.resize();
});
