...
var chart_bestScoreProblemStatisticChart0_d645 = new Chart(document.getElementById('chart_bestScoreProblemStatisticChart0_d645'), {
    type: 'line',
    data: {
        labels: [
            3, 4, 5, 7, 10, 11, 12, 14, 15, 16, 17, 300000
        ],
        datasets: [
            {
                ...
                }, 
{
    ...
    options: {
        ...
        plugins: {
            title: {
                display: true,
                text: 'oled-bench-4c-21o-30ts-baking-maint best hard score statistic'
            },
            tooltip: {
                callbacks: {
...
window.addEventListener('beforeprint', () => {
  chart_bestScoreProblemStatisticChart0_d645.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScoreProblemStatisticChart0_d645.resize();
});
