...
var chart_bestScoreProblemStatisticChart0_b2d0b = new Chart(document.getElementById('chart_bestScoreProblemStatisticChart0_b2d0b'), {
    type: 'line',
    data: {
        labels: [
            58, 59, 61, 63, 64, 65, 66, 68, 69, 73, 76, 80, 81, 282, 314, 317, 328, 420, 422, 424, 436, 528, 743, 750, 782, 788, 806, 300000
        ],
        datasets: [
            {
                ...
                }, 
{
    ...
    options: {
        ...
        plugins: {
            title: {
                display: true,
                text: 'oled-bench-20c-101o-60ts-baking-maint best hard score statistic'
            },
            tooltip: {
                callbacks: {
...
window.addEventListener('beforeprint', () => {
  chart_bestScoreProblemStatisticChart0_b2d0b.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScoreProblemStatisticChart0_b2d0b.resize();
});
