...
var chart_bestScoreProblemStatisticChart0_826d2 = new Chart(document.getElementById('chart_bestScoreProblemStatisticChart0_826d2'), {
    type: 'line',
    data: {
        labels: [
            236, 244, 247, 249, 251, 256, 257, 260, 261, 266, 267, 1145, 1156, 1158, 1167, 1197, 1919, 1946, 1947, 1979, 2025, 37342, 37489, 37696, 38711, 300000, 300001, 300002, 300003, 300012
        ],
        datasets: [
            {
                ...
                }, 
{
    ...
    options: {
        ...
        plugins: {
            title: {
                display: true,
                text: 'oled-bench-200c-1001o-30ts-baking-maint best hard score statistic'
            },
            tooltip: {
                callbacks: {
...
window.addEventListener('beforeprint', () => {
  chart_bestScoreProblemStatisticChart0_826d2.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScoreProblemStatisticChart0_826d2.resize();
});
