...
var chart_bestScoreProblemStatisticChart0_8bdd2 = new Chart(document.getElementById('chart_bestScoreProblemStatisticChart0_8bdd2'), {
    type: 'line',
    data: {
        labels: [
            100, 102, 105, 106, 108, 109, 113, 130, 508, 524, 544, 552, 589, 853, 868, 880, 897, 908, 2427, 2470, 2473, 2483, 300000, 300001, 300002
        ],
        datasets: [
            {
                ...
                }, 
{
    ...
    options: {
        ...
        plugins: {
            title: {
                display: true,
                text: 'oled-bench-100c-501o-30ts-baking-maint best hard score statistic'
            },
            tooltip: {
                callbacks: {
...
window.addEventListener('beforeprint', () => {
  chart_bestScoreProblemStatisticChart0_8bdd2.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScoreProblemStatisticChart0_8bdd2.resize();
});
