...
var chart_bestScoreProblemStatisticChart0_83867 = new Chart(document.getElementById('chart_bestScoreProblemStatisticChart0_83867'), {
    type: 'line',
    data: {
        labels: [
            300000
                ...
                }, 
{
    ...
    options: {
        ...
        plugins: {
            title: {
                display: true,
                text: 'oled-bench-2c-11o-30ts-baking-maint best hard score statistic'
            },
            tooltip: {
                callbacks: {
...
window.addEventListener('beforeprint', () => {
  chart_bestScoreProblemStatisticChart0_83867.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScoreProblemStatisticChart0_83867.resize();
});
