...
var chart_bestScoreDistributionSummaryChart0_2f15e = new Chart(document.getElementById('chart_bestScoreDistributionSummaryChart0_2f15e'), {
    type: 'boxplot',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_bestScoreDistributionSummaryChart0_2f15e.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScoreDistributionSummaryChart0_2f15e.resize();
});