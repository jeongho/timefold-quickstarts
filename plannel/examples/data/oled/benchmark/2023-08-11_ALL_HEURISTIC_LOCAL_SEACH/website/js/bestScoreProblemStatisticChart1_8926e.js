...
var chart_bestScoreProblemStatisticChart1_8926e = new Chart(document.getElementById('chart_bestScoreProblemStatisticChart1_8926e'), {
    type: 'line',
    data: {
        labels: [
            300000
                ...
                }, 
{
    ...
    options: {
        ...
        plugins: {
            title: {
                display: true,
                text: 'oled-bench-2c-11o-60ts-baking-maint best medium score statistic'
            },
            tooltip: {
                callbacks: {
...
window.addEventListener('beforeprint', () => {
  chart_bestScoreProblemStatisticChart1_8926e.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScoreProblemStatisticChart1_8926e.resize();
});
