...
var chart_bestScoreProblemStatisticChart0_9ec9b = new Chart(document.getElementById('chart_bestScoreProblemStatisticChart0_9ec9b'), {
    type: 'line',
    data: {
        labels: [
            300000
...
window.addEventListener('beforeprint', () => {
  chart_bestScoreProblemStatisticChart0_9ec9b.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScoreProblemStatisticChart0_9ec9b.resize();
});
