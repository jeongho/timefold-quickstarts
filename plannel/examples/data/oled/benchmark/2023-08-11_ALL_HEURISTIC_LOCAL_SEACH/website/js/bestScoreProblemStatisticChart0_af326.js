...
var chart_bestScoreProblemStatisticChart0_af326 = new Chart(document.getElementById('chart_bestScoreProblemStatisticChart0_af326'), {
    type: 'line',
    data: {
        labels: [
            16, 17, 18, 19, 20, 22, 23, 26, 41, 42, 45, 46, 111, 114, 116, 123, 130, 131, 132, 135, 142, 300000
        ],
        datasets: [
            {
                ...
                }, 
{
    ...
    options: {
        ...
        plugins: {
            title: {
                display: true,
                text: 'oled-bench-6c-31o-60ts-baking-maint best hard score statistic'
            },
            tooltip: {
                callbacks: {
...
window.addEventListener('beforeprint', () => {
  chart_bestScoreProblemStatisticChart0_af326.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScoreProblemStatisticChart0_af326.resize();
});
