...
var chart_winningScoreDifferenceSummaryChart0_27ab7 = new Chart(document.getElementById('chart_winningScoreDifferenceSummaryChart0_27ab7'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_winningScoreDifferenceSummaryChart0_27ab7.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_winningScoreDifferenceSummaryChart0_27ab7.resize();
});