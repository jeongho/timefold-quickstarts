...
var chart_bestScoreProblemStatisticChart0_76e18 = new Chart(document.getElementById('chart_bestScoreProblemStatisticChart0_76e18'), {
    type: 'line',
    data: {
        labels: [
            140, 142, 148, 149, 150, 153, 156, 157, 158, 164, 169, 817, 840, 845, 849, 863, 871, 881, 903, 920, 1531, 1542, 1548, 1574, 1611, 300000, 300001, 300002
        ],
        datasets: [
            {
                ...
                }, 
{
    ...
    options: {
        ...
        plugins: {
            title: {
                display: true,
                text: 'oled-bench-40c-201o-60ts-baking-maint best hard score statistic'
            },
            tooltip: {
                callbacks: {
...
window.addEventListener('beforeprint', () => {
  chart_bestScoreProblemStatisticChart0_76e18.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScoreProblemStatisticChart0_76e18.resize();
});
