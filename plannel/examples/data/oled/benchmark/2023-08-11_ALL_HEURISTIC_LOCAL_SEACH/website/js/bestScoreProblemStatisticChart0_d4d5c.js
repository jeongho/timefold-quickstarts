...
var chart_bestScoreProblemStatisticChart0_d4d5c = new Chart(document.getElementById('chart_bestScoreProblemStatisticChart0_d4d5c'), {
    type: 'line',
    data: {
        labels: [
            22, 32, 33, 34, 35, 38, 40, 41, 44, 51, 193, 200, 208, 210, 242, 273, 296, 300, 309, 315, 321, 328, 334, 300000, 300001
        ],
        datasets: [
            {
                ...
                }, 
{
    ...
    options: {
        ...
        plugins: {
            title: {
                display: true,
                text: 'oled-bench-40c-201o-30ts-baking-maint best hard score statistic'
            },
            tooltip: {
                callbacks: {
...
window.addEventListener('beforeprint', () => {
  chart_bestScoreProblemStatisticChart0_d4d5c.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScoreProblemStatisticChart0_d4d5c.resize();
});
