...
var chart_winningScoreDifferenceSummaryChart0_6f31f = new Chart(document.getElementById('chart_winningScoreDifferenceSummaryChart0_6f31f'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_winningScoreDifferenceSummaryChart0_6f31f.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_winningScoreDifferenceSummaryChart0_6f31f.resize();
});