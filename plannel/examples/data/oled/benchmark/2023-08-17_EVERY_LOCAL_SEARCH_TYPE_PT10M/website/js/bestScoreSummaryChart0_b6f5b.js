...
var chart_bestScoreSummaryChart0_b6f5b = new Chart(document.getElementById('chart_bestScoreSummaryChart0_b6f5b'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_bestScoreSummaryChart0_b6f5b.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScoreSummaryChart0_b6f5b.resize();
});