...
var chart_timeSpentSummaryChart_ed659 = new Chart(document.getElementById('chart_timeSpentSummaryChart_ed659'), {
    type: 'bar',
    data: {
        labels: [
                ...
                }, 
{
                  ...
                  ,
                  data: [
                    600000, 600000, 600001, 600000, 600000, 600000, 600000, 600000, 600000, 600000, 600000, 600000, 600000, 600000
                  ]
                }, 
{
...
window.addEventListener('beforeprint', () => {
  chart_timeSpentSummaryChart_ed659.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_timeSpentSummaryChart_ed659.resize();
});