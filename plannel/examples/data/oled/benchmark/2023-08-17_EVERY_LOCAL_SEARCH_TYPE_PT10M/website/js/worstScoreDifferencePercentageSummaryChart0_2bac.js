...
var chart_worstScoreDifferencePercentageSummaryChart0_2bac = new Chart(document.getElementById('chart_worstScoreDifferencePercentageSummaryChart0_2bac'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_worstScoreDifferencePercentageSummaryChart0_2bac.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_worstScoreDifferencePercentageSummaryChart0_2bac.resize();
});