...
var chart_bestScoreSummaryChart1_5e3ea = new Chart(document.getElementById('chart_bestScoreSummaryChart1_5e3ea'), {
    type: 'bar',
    data: {
        labels: [
        ...
        datasets: [
            {
                  ...
                  ,
                  data: [
                    -1011, -2014, -1775, -3594, -276, -549, -71, -136, -376, -743, -54, -107, -56, -106
                  ]
                }, 
{
                  label: 'TABU_SEARCH',
                  ...
                  ,
                  data: [
                    -1081, -2663, -2235, -6669, -296, -589, -71, -136, -423, -823, -54, -107, -59, -107
                  ]
                }, 
{
...
,
                  data: [
                    -1008, -2003, -1749, -3523, -267, -531, -71, -136, -371, -736, -54, -107, -53, -105
                  ]
                }, 
{
                  label: 'GREAT_DELUGE',
                  ...
                  ,
                  data: [
                    -1012, -2631, -2018, -4893, -269, -533, -71, -136, -375, -965, -54, -107, -53, -106
                  ]
                }, 
{
                  ...
                  ,
                  data: [
                    -2827, -5473, -5839, -11139, -445, -1009, -71, -136, -1005, -2084, -54, -107, -60, -170
                  ]
                }
        ]
    },
...
window.addEventListener('beforeprint', () => {
  chart_bestScoreSummaryChart1_5e3ea.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScoreSummaryChart1_5e3ea.resize();
});